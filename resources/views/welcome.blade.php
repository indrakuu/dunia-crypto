...
@section('content')
    ...
    <div class="page-banner home-banner">
      <div class="row align-items-center flex-wrap-reverse h-100">
        <div class="col-md-6 py-5 wow fadeInLeft">
          ...
          <p class="text-lg text-grey mb-5">View live top cryptocurrency prices, market cap and trading volume. Discover new coins and trends today in the market.</p>
          <a href="{{ route('crypto') }}" class="btn btn-primary btn-split">Check out Crypto <div class="fab"><span class="mai-play"></span>
            </div></a>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            ...
            <div class="body">
              <h5 class="text-secondary">{{ number_format($data3['total_cryptocurrencies'],0) }} Cryptocurrencies</h5>
              <p>There are currently {{ number_format($data3['total_cryptocurrencies'],0) }} cryptocurrencies available</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            ...
            <div class="body">
              ...
              <p>There are currently {{ number_format($data3['active_exchanges'],0) }} spot exchanges available</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            ...
            <div class="body">
              ...
              <p>Currently there are a total of ${{ number_format($data3['quote']['USD']['total_market_cap']) }} Market Cap</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="page-section">
    <div class="container">
        ...
        <tr>
            <td>{{ $item['cmc_rank'] }}</td>
            <td><img class="img-fluid" style="width: 10%" src="https://s2.coinmarketcap.com/static/img/coins/64x64/{{ $item['id'] }}.png" alt=""> <a href="{{ route('detail.crypto', $item['id']) }}">{{ $item['name'] }}</a> </td>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 py-3 wow zoomIn">
          <div class="features">
            <div class="header mb-3">
              <img class="img-fluid" style="width: 70px" src="https://s2.coinmarketcap.com/static/img/exchanges/64x64/{{ $item['id'] }}.png" alt=""> 
            </div>
